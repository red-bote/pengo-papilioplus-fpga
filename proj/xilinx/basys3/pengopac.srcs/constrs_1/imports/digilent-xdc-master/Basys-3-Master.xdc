...
##Pmod Header JB
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports PS2DAT1];#Sch name = JB1
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports PS2CLK1];#Sch name = JB3
