...
#REM concatenate consecutive ROM regions
cat $rom_path_src/tnt.5 $rom_path_src/tnt.6 > $rom_path/gfx1.bin
cat $rom_path_src/tnt.1 $rom_path_src/tnt.2 $rom_path_src/tnt.3 $rom_path_src/tnt.4 > $rom_path/main.bin
